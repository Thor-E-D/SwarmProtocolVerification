...
def do_full_test(base_path: str, names_of_files: List[str], name_of_query_file: str, name_amount_dict: Dict[str,int], loop_counter: int, standardSetting: bool):
    paths = []
    ...
    currentModel = createModel(jsonTransfers, name_amount_dict, loop_counter, standardSetting)
