...
def test_multi_branch_time():
    ...
    model_settings = ModelSettings({"O": 1, "R1": 1, "R2": 1, "R3": 1},{"O": DelayType.EVENTS_EMITTED, "R1": DelayType.EVENTS_EMITTED, "R2": DelayType.EVENTS_EMITTED, "R3": DelayType.EVENTS_EMITTED})
    model_settings.path_bound = 1
    model_settings.branch_tracking = True
    model_settings.delay_amount = {"O": 2, "R1": 2, "R2": 2, "R3": 2}
